...
import com.example.springsecurityjwtdemo.exception.JWTAccessDeniedHandler;
import com.example.springsecurityjwtdemo.exception.JWTAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    @Qualifier("springSecurityUserServiceImpl")
